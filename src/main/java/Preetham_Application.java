...
public class Preetham_Application extends MessageExchanges{
	...
	public static void mainfun() throws URISyntaxException {
		...
		final URI MyDevice = new URI("wss://localhost:9090");
		final URI FriendDevice = new URI("wss://localhost:8080");
        ...
        start();
        try {
            System.out.println("Preetham sends a ReadPropRequest to Pradeep");
        ...
        System.out.println("Preetham sends a WritePropRequest to Pradeep");
        byte[] bytes = encode(50);
